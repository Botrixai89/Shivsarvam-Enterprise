...
export const metadata: Metadata = {
  title: 'About Shivsarvam Enterprises | Authorized Chemtex & Indokem Distributor Chhattisgarh',
  description:
    'Learn about Shivsarvam Enterprises — authorized distributor of Chemtex & Indokem chemicals in Chhattisgarh & Maharashtra. 18+ years experience, 500+ clients, 4 industry segments served from Raipur.',
  keywords: [
    'Shivsarvam Enterprises about',
    'Chemtex authorized distributor Chhattisgarh',
    'Indokem authorized distributor Raipur',
    'industrial chemical company Raipur',
    'chemical distributor Chhattisgarh Maharashtra',
    'Laxmidatta Bajpayee chemical',
  ],
  alternates: {
    canonical: 'https://www.shivsarvam.in/about',
  },
  openGraph: {
    title: 'About Shivsarvam Enterprises | Authorized Chemtex & Indokem Distributor',
    description:
      'Authorized distributor of Chemtex & Indokem. Trusted chemical solutions across Chhattisgarh & Maharashtra.',
    url: 'https://www.shivsarvam.in/about',
